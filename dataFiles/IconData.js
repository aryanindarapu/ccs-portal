...
export const dataDownParents = [
  {
    key: 'app',
    path: require('../assets/appIcons/canvasP.jpg'),
    name: 'Canvas Parent',
  ...
  {
    key: 'app',
    path: require('../assets/appIcons/powerschool.png'),
    name: 'PowerSchool',
  ...
  {
    key: 'app',
    path: require('../assets/appIcons/ez.png'),
    name: 'EZSchoolPay',
  ...
  {
    key: 'app',
    path: require('../assets/appIcons/remind.png'),
    name: 'Remind',
...
export const dataDownStudents = [
  {
    key: 'app',
    path: require('../assets/appIcons/canvasS.png'),
    name: 'Canvas Student',
  ...
  {
    key: 'app',
    path: require('../assets/appIcons/stopit.png'),
    name: 'STOPit',
